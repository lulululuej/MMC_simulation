...
int next_event_type, num_events, server_status, num_in_q, num_of_server;
...
int main() {
    ...
    fscanf(infile, "%d %Lf %Lf", &num_delays_required, &mean_inter_arr_time, &mean_service_time, &num_of_server);
